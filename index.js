...
async function run() {
  try {
    ...
    const productsCollection = client.db("online_shop2").collection("products");
    const orderCollection = client.db("online_shop2").collection("orders");
    const reviewCollection = client.db("online_shop2").collection("reviews");
    const usersCollection = client.db("online_shop2").collection("users");
